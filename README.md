...
The discovery endpoint publishes no pricing metadata. The plugin transcribes rates from the two vendor documentation pages in `PRICING_SOURCE_URLS` (`https://commandcode.ai/models` and `https://commandcode.ai/docs/resources/pricing-limits`) and stamps them with `PRICING_VERIFIED_ON` (`2026-09-11`).
...
| ----------------------------------------------------------------------------------------------------- | --------------------------- | ---------------------------------------------------------------------------- |
| `deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-flash-vision-exp`, `deepseek/deepseek-v4.1-flash` | 0.15 / 0.6 / 0.003          | off-peak, 17 h a day, peak 0.3 / 1.2 at 01–04 and 06–10 UTC, weekdays only   |
| `deepseek/deepseek-v4-pro`                                                                            | 0.66 / 1.98 / 0.022         | off-peak, 17 h a day, peak 1.32 / 3.96 at 01–04 and 06–10 UTC, weekdays only |
