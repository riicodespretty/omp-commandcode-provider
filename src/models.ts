...
export const MODEL_CAPABILITIES = {
	...
	"Qwen/Qwen3.8-Flash": { reasoning: true, vision: true },
	"Qwen/Qwen3.8-Max": { reasoning: true, vision: true },
	"Qwen/Qwen3.8-Max-0902": { reasoning: true, vision: true },
	"claude-fable-5": { reasoning: true, vision: true },
	"claude-fable-5-1": { reasoning: true, vision: true },
	...
	"google/gemini-3.8-flash": { reasoning: true, vision: true },
	...
	"inclusionai/ling-3.0-flash-sante:free": { reasoning: true, vision: false },
	"meituan/LongCat-2.0:free": { reasoning: true, vision: false },
	...
	"meta/muse-spark-1.3": { reasoning: true, vision: true },
	"meta/muse-spark-1.3-contributor": { reasoning: true, vision: true },
	...
	"tencent/hy4-preview": { reasoning: true, vision: false },
